    ...
    public void loadRecord() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))){
            ...
            while ((line = br.readLine()) != null) {
                ...
                Boolean isOwnerExisting = false;
                for (Owner onerCheck: ownerList) {
                    if(onerCheck.getOwnerID().equals(ownr.getOwnerID())){
                        isOwnerExisting=true;
                    }
                }
                if (!isOwnerExisting){
                    ownerList.add(ownr);
                ...
                Boolean isVehicleExisting = false;
                for (Vehicle vehCheck: vehiList) {
                    if(vehCheck.getVehID().equals(vehi.getVehID())){
                        isVehicleExisting=true;
                    }
                }
                ...
                Boolean isInsureExisting = false;
                for (Insurance insCheck: insuList) {
                    if(insCheck.getInsuranceID().equals(insu.getInsuranceID())){
                        isInsureExisting=true;
                    }
                }
                if (!isInsureExisting){
